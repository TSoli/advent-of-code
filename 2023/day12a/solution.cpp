...
int getArrangmenets(std::vector<int> nums,
                    std::vector<std::pair<char, int>> contiguousBlocks);
...
int main(int argc, char *argv[]) {
  ...
  while (inf >> springs) {
    ...
    arrangements += getArrangmenets(nums, contiguousBlocks);
  }
...
std::vector<std::pair<char, int>> getContiguousBlocks(
...
int getArrangmenets(std::vector<int> nums,
  ...
  return getArrangmenets(nums, contiguousBlocks) +
         getArrangmenets(numsNoFault, blocksNoFault);
}
